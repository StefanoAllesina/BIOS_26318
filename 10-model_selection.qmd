...
## Using tidymodels for modeling and cross-validation
...
2.  [Tidymodels tutorial](https://www.tidymodels.org/start/)

3.  [Emil Hvitfeldt, Tidymodels for Introduction to Statistical Learning in R](https://emilhvitfeldt.github.io/ISLR-tidymodels-labs/index.html)

4.  [Mark H Hansen and Bin Yu Model Selection and the Principle of Minimum Description Length](https://www.tandfonline.com/doi/abs/10.1198/016214501753168398).
