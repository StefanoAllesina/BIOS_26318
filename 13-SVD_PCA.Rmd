...
At the hearth of PCA is a particular matrix decomposition (or factorization): we represent the matrix $X$ as a product of other matrices (or, equivalently, a sum of matirces). In particular, SVD is defined by the equation:
...
For example, let's look at the distance in *km* between cities in Illinois:
