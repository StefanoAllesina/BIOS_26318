...
url <- "https://imgs.xkcd.com/comics/null_hypothesis.png"
```
...
```{webr-r}
# Define variable containing URL
url <- "https://imgs.xkcd.com/comics/p_values.png"
```
...
```{webr-r}
# Define variable containing URL
url <- "https://imgs.xkcd.com/comics/significant.png"
```
...
```{webr-r}
dt <- read_csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/medals.csv")
dt
```
