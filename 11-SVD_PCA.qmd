...
```{webr-r}
stefano <- as.matrix(read.csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/stefano.txt"))
...
```{webr-r}
dt <- read.csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/handwritten_digits.csv") |> 
  arrange(id, x, y)
head(dt)
```
...
```{webr-r}
# read distances US
usa <- read.csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/dist_US.csv")
