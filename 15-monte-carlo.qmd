...
```{webr-r}
bears <- read.csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/bears.csv")
...
```{webr-r}
dt <- read.csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/Pikedata.csv")
```
...
```{webr-r}
set.seed(1)
source("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/curveball.R")
...
```{webr-r}
finches <- as.matrix(read.csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/finches.csv"))
