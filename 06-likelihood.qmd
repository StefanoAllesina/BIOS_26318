...
url <- "https://imgs.xkcd.com/comics/modified_bayes_theorem.png"
```
...
![Bayesian hypothesis testing tree with prior probability 0.1](images/prob_tree_tikz1.png){width="50%"}

![Bayesian hypothesis testing tree with prior probability 0.01](images/prob_tree_tikz2.png){width="50%"}
...
```{r, echo=FALSE}
# Define variable containing URL
url <- "https://imgs.xkcd.com/comics/frequentists_vs_bayesians.png"
```
