...
dat <- read_csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/Piwowar_2011.csv") 
...
```{webr-r}
olympics <- read_csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/100m_dash.csv")
```
...
```{webr-r}
dat <- read_csv("https://raw.githubusercontent.com/StefanoAllesina/BIOS_26318/refs/heads/master/data/Anscombe_1973.csv")
```
